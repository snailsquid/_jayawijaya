...
const colors: Record<QuestionState, string> = { unseen: 'bg-quiz-unseen', unanswered: 'bg-background', answered: 'bg-quiz-answered', flagged: 'bg-quiz-flagged' }
