...
describe('getSubscriptionSummary', () => {
  it('accumulates overlapping verified passes in chronological order', () => {
    const summary = getSubscriptionSummary([
      payment(),
      payment({ id: 'payment-2', verifiedAt: '2026-08-10T00:00:00.000Z' }),
    ], new Date('2026-09-01T12:00:00.000Z'));
    expect(summary).toMatchObject({ active: true, daysRemaining: 29 });
    expect(summary.expiresAt?.toISOString()).toBe('2026-09-30T00:00:00.000Z');
  });
