  ...
  return (
    <main className="relative flex min-h-screen flex-col items-center justify-center gap-6 p-6 text-center">
      ...
      <div className="space-y-3">
        ...
        {isAcromion ? (
          <p className="mx-auto max-w-md text-muted-foreground">
            ...
            <a
              className="font-semibold underline underline-offset-4"
              href="https://www.instagram.com/acromion2024/"
            >
              acromion
            </a>
          </p>
          ...
          <p className="mx-auto max-w-md text-muted-foreground">
            A modular quiz app with practice and exam modes, multiple-choice and
            text answers, and local persistence.
          </p>
        )}
      </div>
      <p className="text-sm text-muted-foreground">
        ...
        <a
          className="font-semibold underline underline-offset-4"
          href="https://www.linkedin.com/in/arkandhiya-ibrahim-dewantara-576059235/"
        >
          ark
        </a>
        ,{" "}
        <a
          href="https://jambee.games"
      ...
      <div className="flex w-full max-w-xs flex-col gap-3">
        ...
        >
          <BookOpen /> How to create modules?
        </Button>
      </div>
      <InstallPrompt />
    </main>
